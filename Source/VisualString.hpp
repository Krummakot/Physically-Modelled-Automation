...
#ifndef VisualString_hpp
#define VisualString_hpp

#include <JuceHeader.h>

//using namespace std;

class VisualString : public juce::Component {
    
public:
    
    // Constructor function (special function - no return type, name = Class name)
    VisualString();
    VisualString(NamedValueSet& parameters, double k);
